...
// Unificamos la llamada a usePerfumes para evitar errores y duplicados
const {
    perfumes,
    loading,
    cart,
    ...
    cartTotal,
    confirmPurchase,
    handleImageSelect // Necesario para que funcione la subida de imagen en el modal de agregar
} = usePerfumes('Tubos Árabes');
...
<template>
    <div class="bg-stone-900 font-sans text-stone-200 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto relative">
            ...
            <p class="text-stone-400 font-light uppercase tracking-widest text-sm">Fragancias en Tubo</p>
        </div>
        </section>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <div v-for="perfume in perfumes" :key="perfume._id" class="bg-stone-800 border border-stone-700 hover:border-amber-600 transition-colors duration-300 group rounded-sm overflow-hidden p-4" style="content-visibility: auto;">
