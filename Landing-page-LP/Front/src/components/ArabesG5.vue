...
// Usamos la marca exacta definida en Bienvenido.vue y la Base de Datos
const {
    perfumes,
    loading,
    cart,
...
<template>
    <div class="bg-stone-900 font-sans text-stone-200 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto relative">
            ...
            <p class="text-stone-400 font-light uppercase tracking-widest text-sm">Alta Calidad Accesible</p>
        </div>
        </section>
